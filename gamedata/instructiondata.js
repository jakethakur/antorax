var Instructions = [
		...
		pages: [
			{
				...
				text: "<p>Welcome to the mystical kingdom of Antorax - a world full of immersion, magic, archaeology, and no third dimension. Regardless, in this cruel and unforgiving world, I should probably let you know how everything works, rather than drop you in unawares and let you immediately die.</p>",
			},
			{
				title: "Movement",
			...
			},
			{
				...
				text: "<p>To make money and earn new items, you’ll need to know how to talk to people. Luckily, for those of you who’d prefer not to initiate conversation, it seems that everybody wants to talk to you! Just walk on up to someone and poof! Dialogue!</p>",
			},
			{
				title: "Getting Back to Instructions",
				text: "<p>If you ever forget anything you read here and want to come back, simply click on the yellow bookmark with a compass on it. That page is known as your Adventurer's Log, and also contains useful information of what you might want to do next. Bear in mind on your travels!</p>",
			},
		],
	},
	{
	...
	},
	{
		...
		pages: [
			{
				title: "Banners",
				text: "<p>Referring to before, where there’s civilisation, there’s not only buildings but capitalism too! It appears that the ruling kingdoms of Antorax have felt the need to mark their territory by placing banners all over the place, kind of like how animals wee on their favourite tree. As you approach their town, the number of banners you can see will increase, leading up to a gateway that you can go through.</p>",
			},
			{
				title: "Water",
				text: "<p>Water, unlike most other games, doesn’t actually kill you - it just slows you down a bit. To be honest, it's just easier to find a bridge. Also, you can walk on lily pads! Somehow…</p>",
			},
			{
				title: "Changing area",
				text: "<p>When you wish to enter a new area, touch the edge of the map or anything else that leads to a new area, such as a door, and you will be magically transported to a new place. You’d think that the developers would have cared enough to make the whole world one open space but apparently they couldn’t be bothered. But hey, what do I know, I’m just a writer!</p>",
			},
		],
	},
	{
	...
	},
	{
		...
		pages: [
			{
				title: "Items",
				text: "<p>What kind of half-baked RPG would this be without limited inventory space. After a three minute debate, the devs decided to limit your space because otherwise the whole game would be pointless. To view your inventory click the red bookmark with a sword on it. You can increase your inventory capacity by placing a bag in the last slot of your hotbar so you can carry around even more useless gear with sentimental value.</p>",
			},
			{
				title: "Weapons and Armour",
				text: "<p>Aside from miscellaneous items, you have to also carry around your armour and weapons. Armour is shown on the left of the main inventory in four boxes; drag a piece of armour from the main inventory into its slot to equip it. Your weapon is the lonely box above the armour and it works exactly the same as the armour boxes. Your armour reduces the damage you take, your weapon increases the damage you deal and different gear has different properties. This could be poison, more range, less cooldown or even more coolness (actually, no). To view your character’s total stats, hover over your player’s head above your weapon.</p>",
			},
		],
	},
		/*{
