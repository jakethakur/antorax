...
var Items = {
	helm: [
		...
		},
		{
			...
			obtain: "Can be bought from a merchant during the Christmas event.",
			event: "Christmas",
			sellPrice: 4,
			stats: {
				defence: 2,
	...
	chest: [
		...
		},
		{
			...
			obtain: "Can be bought from a merchant during the Samhain event.",
			event: "Samhain",
			stats: {
				defence: 1,
				dodgeChance: 40,
	...
	boots: [
		...
		},
		{
			...
			obtain: "Can be received as a reward for completing the quest 'To the Logging Camp'.",
			stats: {
				defence: 1,
				walkSpeed: 30,
			},
	...
	sword: [
		...
		},
		{
			...
			rarity: "common",
			sellPrice: 1,
			obtain: "Can be bought from a merchant in the Fishers' Valley.",
			stats: {
				damage: 2,
				defence: 1,
			},
